...
// Mock trending movies (subset of above + extras)
export const MOCK_TRENDING = MOCK_MOVIES.slice(0, 10);

// Mock genre preference data for chart
export const MOCK_GENRE_PREFERENCES = [
  { genre: 'Sci-Fi', count: 24, color: '#E50914' },
  { genre: 'Thriller', count: 18, color: '#FF6B35' },
  { genre: 'Action', count: 15, color: '#F7B731' },
  { genre: 'Drama', count: 13, color: '#26de81' },
  { genre: 'Mystery', count: 11, color: '#4BCBEB' },
  { genre: 'Crime', count: 8, color: '#a55eea' },
  { genre: 'Horror', count: 6, color: '#fc5c65' },
  { genre: 'Romance', count: 5, color: '#fd9644' },
];
