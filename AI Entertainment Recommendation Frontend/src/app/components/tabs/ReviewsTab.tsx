            ...
            <div style={{ display: 'flex', gap: 10, marginBottom: 20, flexWrap: 'wrap' }}>
              {[
                ...
                <div key={s.label} style={{
                  flex: 1, minWidth: 90, background: '#1a1a1a', borderRadius: 10, padding: '10px 14px',
                  border: `1px solid ${s.color}22`,
                }}>
                  <p style={{ color: s.color, fontSize: '1.3rem', fontWeight: 700, margin: 0 }}>{s.value}%</p>
                  <p style={{ color: '#666', fontSize: '0.72rem', margin: 0 }}>{s.label}</p>
                </div>
              ))}
            </div>
