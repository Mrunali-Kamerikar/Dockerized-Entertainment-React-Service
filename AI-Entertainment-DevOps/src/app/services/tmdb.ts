...
export const TMDB_API_KEY = '67923eabc51ef1632e02ab9b5d6c710e';
...
const TMDB_BEARER_TOKEN = 'eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI2NzkyM2VhYmM1MWVmMTYzMmUwMmFiOWI1ZDZjNzEwZSIsInN1YiI6IjVmNWQ0ZjdjNGNhNjc2MDAzNWY3MzZmOCIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.n7KxFQ0WXVm4Fqr4jE7VYqJH4qN8X0uOuYKOy8P8dGo';

// Log TMDB setup on load
...
const cachedFetch = async (url: string): Promise<unknown> => {
  ...
  try {
    ...
    clearTimeout(timeoutId);
    // Only log error on first failure to reduce console noise
