...
// Just sign in with Google, click "Create API Key", and paste it below
// ============================================

const API_KEY = 'AIzaSyBMxvDxm-zjg4MPNowaKNTpbpPQWKmN1HU'; // 👈 Replace this with your actual API key
